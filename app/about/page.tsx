...
function LocationMap() {
  ...
  return (
    <section aria-labelledby="map-section-title">
      ...
      {/* Map container */}
      <div style={{ position: "relative", background: "#eaecf5", borderRadius: 16, overflow: "hidden", border: "1px solid #dde0ef" }}
        role="region"
      ...
      >
        ...
        >
          ...
          {/* Background counties — grey */}
          {[
            {fips:"40003",name:"Alfalfa",path:"M 396.0,56.3 L 396.0,70.4 L 362.3,70.4 L 361.5,12.3 L 371.2,12.4 L 376.4,12.5 L 377.0,12.5 L 385.5,12.5 L 387.0,12.5 L 387.8,12.5 L 390.2,12.5 L 392.6,12.4 L 395.4,12.4 L 395.6,56.3 L 396.0,56.3 Z",lx:378.7,ly:41.4},
            {fips:"40011",name:"Blaine",path:"M 354.2,102.7 L 357.0,102.6 L 387.7,102.7 L 387.9,150.4 L 379.6,150.4 L 379.6,169.2 L 355.3,169.2 L 354.6,169.2 L 354.6,140.9 L 354.2,102.7 Z",lx:371.1,ly:135.9},
            {fips:"40015",name:"Caddo",path:"M 355.6,244.7 L 355.5,218.4 L 355.3,178.7 L 355.3,169.2 L 379.6,169.2 L 380.2,188.1 L 396.6,188.0 L 396.9,244.7 L 355.6,244.7 Z",lx:376.1,ly:207.0},
            {fips:"40019",name:"Carter",path:"M 487.8,318.7 L 484.9,329.7 L 438.6,329.6 L 438.5,306.0 L 438.5,282.4 L 455.0,282.4 L 455.0,296.6 L 479.7,296.7 L 487.8,301.3 L 487.8,318.7 Z",lx:463.1,ly:306.0},
            {fips:"40027",name:"Cleveland",path:"M 429.9,188.1 L 449.4,188.1 L 461.8,188.1 L 471.4,188.1 L 471.4,236.8 L 455.8,232.9 L 454.8,220.7 L 440.1,205.8 L 438.9,197.7 L 429.9,192.4 L 429.9,188.1 Z",lx:450.7,ly:212.4},
            {fips:"40039",name:"Custer",path:"M 296.3,141.0 L 354.6,140.9 L 354.6,169.2 L 355.3,169.2 L 355.3,178.7 L 297.2,178.6 L 297.2,173.8 L 296.3,141.0 Z",lx:325.8,ly:159.8},
            {fips:"40043",name:"Dewey",path:"M 295.9,119.2 L 295.8,102.8 L 329.2,103.1 L 354.2,102.7 L 354.6,140.9 L 296.3,141.0 L 295.9,119.2 Z",lx:325.2,ly:121.9},
            {fips:"40045",name:"Ellis",path:"M 247.3,114.6 L 247.3,66.5 L 247.1,56.3 L 278.3,56.4 L 279.0,102.8 L 295.8,102.8 L 295.9,119.2 L 286.9,122.9 L 282.0,135.1 L 269.6,135.8 L 262.9,130.3 L 262.3,120.6 L 256.1,121.9 L 253.2,130.0 L 247.3,133.5 L 247.3,114.6 Z",lx:271.5,ly:96.1},
            {fips:"40047",name:"Garfield",path:"M 446.3,56.3 L 446.4,56.3 L 446.4,102.8 L 429.6,102.8 L 396.0,102.7 L 396.0,56.3 L 446.3,56.3 Z",lx:421.2,ly:79.5},
            {fips:"40049",name:"Garvin",path:"M 438.5,282.4 L 438.4,263.5 L 430.2,263.5 L 430.2,244.7 L 487.9,244.8 L 487.9,268.3 L 466.9,269.9 L 471.3,282.5 L 455.0,282.4 L 438.5,282.4 Z",lx:459.0,ly:263.6},
            {fips:"40051",name:"Grady",path:"M 396.6,188.0 L 417.2,192.6 L 418.9,192.8 L 419.3,192.0 L 420.1,192.2 L 420.5,192.9 L 420.8,192.5 L 421.6,192.4 L 422.1,191.5 L 424.8,193.9 L 425.7,193.7 L 426.1,193.4 L 427.2,193.8 L 428.0,193.5 L 428.9,192.8 L 429.9,192.6 L 430.2,244.7 L 430.2,263.5 L 397.3,263.5 L 397.2,263.5 L 397.1,244.7 L 396.9,244.7 L 396.6,188.0 Z",lx:413.4,ly:225.8},
            {fips:"40053",name:"Grant",path:"M 446.3,56.3 L 396.0,56.3 L 395.4,12.4 L 400.6,12.4 L 419.7,12.4 L 421.1,12.4 L 422.3,12.4 L 427.9,12.4 L 431.6,12.3 L 435.0,12.4 L 438.3,12.4 L 445.5,12.4 L 446.3,12.4 L 446.3,56.3 Z",lx:420.9,ly:34.3},
            {fips:"40055",name:"Greer",path:"M 293.7,216.6 L 300.1,224.5 L 301.8,244.4 L 306.5,248.3 L 294.0,249.2 L 292.6,258.8 L 273.5,258.8 L 269.3,254.1 L 268.5,235.0 L 256.1,235.1 L 256.1,225.7 L 264.4,225.7 L 264.4,216.3 L 293.7,216.6 Z",lx:281.3,ly:237.6},
            {fips:"40057",name:"Harmon",path:"M 247.3,256.5 L 247.3,225.7 L 256.1,225.7 L 256.1,235.1 L 268.5,235.0 L 269.3,254.1 L 273.5,258.8 L 273.5,282.4 L 259.4,282.6 L 253.4,275.1 L 247.5,276.5 L 247.3,276.6 L 247.3,256.5 Z",lx:260.4,ly:254.2},
            {fips:"40059",name:"Harper",path:"M 247.2,12.1 L 264.2,12.1 L 274.2,12.2 L 282.0,12.3 L 286.5,12.3 L 290.0,12.3 L 296.5,25.4 L 302.6,31.8 L 302.6,56.1 L 278.3,56.4 L 247.1,56.3 L 247.2,12.1 Z",lx:274.9,ly:34.2},
            {fips:"40065",name:"Jackson",path:"M 309.2,300.7 L 305.3,293.6 L 297.8,289.4 L 294.5,296.6 L 291.2,296.8 L 290.2,295.2 L 285.4,292.4 L 280.7,292.0 L 277.4,296.7 L 271.3,296.3 L 265.6,290.7 L 259.4,282.6 L 273.5,282.4 L 273.5,258.8 L 292.6,258.8 L 294.0,249.2 L 306.5,248.3 L 314.2,245.2 L 314.1,261.2 L 321.7,261.3 L 317.7,268.2 L 308.5,283.8 L 309.2,300.7 Z",lx:290.5,ly:273.0},
            {fips:"40073",name:"Kingfisher",path:"M 396.0,102.7 L 429.6,102.8 L 429.7,150.3 L 387.9,150.4 L 387.7,102.7 L 396.0,102.7 Z",lx:408.7,ly:126.6},
            {fips:"40083",name:"Logan",path:"M 471.5,126.9 L 471.5,150.5 L 429.7,150.3 L 429.6,102.8 L 446.4,102.8 L 454.8,103.4 L 454.8,122.2 L 457.2,119.4 L 471.5,126.9 Z",lx:450.6,ly:126.6},
            {fips:"40085",name:"Love",path:"M 484.7,344.3 L 483.7,349.6 L 475.3,366.3 L 471.8,367.8 L 469.8,366.7 L 466.5,359.0 L 466.5,357.0 L 458.2,351.2 L 453.3,356.9 L 449.1,356.9 L 446.3,354.5 L 447.2,351.3 L 447.2,349.1 L 444.6,346.5 L 443.3,346.1 L 441.9,346.7 L 439.8,348.1 L 438.6,348.4 L 438.6,329.6 L 484.9,329.7 L 487.7,342.4 L 484.7,344.3 Z",lx:463.1,ly:348.8},
            {fips:"40093",name:"Major",path:"M 354.2,102.7 L 329.2,103.1 L 328.9,65.7 L 338.0,65.7 L 340.8,70.7 L 355.1,78.1 L 362.3,77.5 L 362.3,70.4 L 396.0,70.4 L 396.0,102.7 L 354.2,102.7 Z",lx:362.5,ly:84.4},
            {fips:"40087",name:"McClain",path:"M 429.9,192.6 L 438.9,197.7 L 440.1,205.8 L 454.8,220.7 L 455.8,232.9 L 471.4,236.8 L 488.0,232.8 L 488.0,244.7 L 487.9,244.8 L 430.2,244.7 L 429.9,192.6 Z",lx:459.0,ly:218.6},
            {fips:"40109",name:"Oklahoma",path:"M 461.8,188.1 L 449.4,188.1 L 429.9,188.1 L 429.9,178.7 L 429.7,150.3 L 471.5,150.5 L 471.5,178.7 L 471.4,188.1 L 461.8,188.1 Z",lx:450.6,ly:169.2},
            {fips:"40137",name:"Stephens",path:"M 393.0,282.4 L 393.0,263.5 L 430.2,263.5 L 438.4,263.5 L 438.5,282.4 L 438.5,306.0 L 393.3,305.9 L 393.3,282.4 L 393.0,282.4 Z",lx:415.7,ly:284.8},
            {fips:"40151",name:"Woods",path:"M 302.6,31.8 L 296.5,25.4 L 290.0,12.3 L 335.1,12.3 L 341.7,12.3 L 347.8,12.3 L 361.5,12.3 L 362.3,70.4 L 362.3,77.5 L 355.1,78.1 L 340.8,70.7 L 338.0,65.7 L 328.9,55.7 L 314.8,35.8 L 302.6,31.8 Z",lx:326.2,ly:45.2},
            {fips:"40153",name:"Woodward",path:"M 278.3,56.4 L 302.6,56.1 L 302.6,31.8 L 314.8,35.8 L 328.9,55.7 L 328.9,65.7 L 329.2,103.1 L 295.8,102.8 L 279.0,102.8 L 278.3,56.4 Z",lx:303.8,ly:67.4},
          ].map(c => (
            <g key={c.fips}>
              <path d={c.path} fill="#dde0ef" stroke="#c4c8dc" strokeWidth={0.6} strokeLinejoin="round" />
              <text x={c.lx} y={c.ly} textAnchor="middle" dominantBaseline="middle" fontSize={4.5} fill="#9ca3af" style={{ userSelect: "none", pointerEvents: "none" }}>{c.name}</text>
            </g>
          ))}

          {/* CADC counties — highlighted blue */}
          {[
            {name:"Beckham",path:"M 247.3,209.2 L 247.3,183.2 L 280.6,183.3 L 280.6,173.8 L 297.2,173.8 L 297.2,178.6 L 297.5,216.3 L 293.7,216.4 L 293.7,216.6 L 264.4,216.3 L 264.4,225.7 L 256.1,225.7 L 247.3,225.7 L 247.3,209.2 Z",lx:272.4,ly:199.8},
            {name:"Canadian",path:"M 429.9,178.7 L 429.9,192.6 L 428.9,192.8 L 428.0,193.5 L 427.2,193.8 L 426.1,193.4 L 425.7,193.7 L 424.8,193.9 L 422.1,191.5 L 421.6,192.4 L 420.8,192.5 L 420.5,192.9 L 420.1,192.2 L 419.3,192.0 L 418.9,192.8 L 417.2,192.6 L 396.6,188.0 L 380.2,188.1 L 379.6,169.2 L 379.6,150.4 L 387.9,150.4 L 429.7,150.3 L 429.9,178.7 Z",lx:404.8,ly:172.1},
            {name:"Comanche",path:"M 393.0,282.4 L 385.0,282.4 L 381.0,288.7 L 364.6,288.6 L 364.6,291.8 L 352.3,293.4 L 352.3,282.4 L 339.4,282.4 L 339.4,244.6 L 355.6,244.7 L 396.9,244.7 L 397.2,263.5 L 393.0,263.5 L 393.0,282.4 Z",lx:368.3,ly:269.0},
            {name:"Cotton",path:"M 390.9,325.0 L 388.5,324.7 L 381.1,322.9 L 378.7,321.0 L 375.6,320.3 L 374.1,321.3 L 372.9,323.4 L 372.8,324.2 L 370.2,326.9 L 366.9,330.4 L 364.6,329.5 L 360.8,322.9 L 357.1,319.9 L 356.3,319.9 L 356.4,301.2 L 352.3,293.4 L 364.6,291.8 L 364.6,288.6 L 381.0,288.7 L 385.0,282.4 L 393.0,282.4 L 393.3,282.4 L 393.3,305.9 L 393.3,322.0 L 390.9,325.0 Z",lx:372.8,ly:306.4},
            {name:"Jefferson",path:"M 405.9,349.3 L 407.8,344.2 L 408.4,338.5 L 405.5,337.2 L 402.6,338.0 L 400.9,338.1 L 397.5,337.0 L 395.8,333.7 L 390.9,325.0 L 393.3,322.0 L 393.3,305.9 L 438.5,306.0 L 438.5,328.4 L 438.6,348.4 L 437.0,348.1 L 435.8,346.7 L 436.4,342.6 L 434.8,340.8 L 431.1,338.5 L 429.9,338.3 L 428.6,338.8 L 427.6,340.4 L 425.0,344.2 L 421.0,349.2 L 417.2,352.8 L 414.7,353.7 L 413.8,353.6 L 406.8,350.1 L 405.9,349.3 Z",lx:414.8,ly:329.8},
            {name:"Kiowa",path:"M 355.5,218.4 L 355.6,244.7 L 339.4,244.6 L 339.4,272.9 L 325.7,272.9 L 325.7,268.2 L 317.7,268.2 L 321.7,261.3 L 314.1,261.2 L 314.2,245.2 L 306.5,248.3 L 301.8,244.4 L 300.1,224.5 L 293.7,216.6 L 293.7,216.4 L 297.5,216.3 L 345.3,216.4 L 355.5,218.4 Z",lx:324.6,ly:244.6},
            {name:"Roger Mills",path:"M 247.3,161.9 L 247.3,133.5 L 253.2,130.0 L 256.1,121.9 L 262.3,120.6 L 262.9,130.3 L 269.6,135.8 L 282.0,135.1 L 286.9,122.9 L 295.9,119.2 L 296.3,141.0 L 297.2,173.8 L 280.6,173.8 L 280.6,183.3 L 247.3,183.2 L 247.3,161.9 Z",lx:272.3,ly:151.2},
            {name:"Tillman",path:"M 329.5,316.2 L 321.0,315.2 L 316.4,315.5 L 313.5,314.9 L 310.8,314.0 L 309.2,305.7 L 309.2,300.8 L 308.5,283.8 L 317.7,268.2 L 325.7,268.2 L 325.7,272.9 L 339.4,272.9 L 339.4,282.4 L 352.3,282.4 L 352.3,293.4 L 356.4,301.2 L 356.3,319.9 L 354.2,319.8 L 349.3,322.6 L 344.2,322.6 L 336.9,320.8 L 332.0,317.5 L 329.5,316.2 Z",lx:332.4,ly:295.4},
            {name:"Washita",path:"M 355.5,218.4 L 345.3,216.4 L 297.5,216.3 L 297.2,178.6 L 355.3,178.7 L 355.5,218.4 Z",lx:326.3,ly:198.5},
          ].map(c => (
            <g key={c.name}>
              <path d={c.path} fill="rgba(1,1,255,0.12)" stroke="rgba(1,1,255,0.45)" strokeWidth={1.2} strokeLinejoin="round" />
              <text x={c.lx} y={c.ly} textAnchor="middle" dominantBaseline="middle" fontSize={5.5} fontWeight="700" fill="#1a1a5e" style={{ userSelect: "none", pointerEvents: "none" }}>{c.name}</text>
            </g>
          ))}

          {/* City labels for key service cities */}
          {[
            {name:"Frederick",x:332.4,y:300},
            {name:"Lawton",x:368.3,y:274},
            {name:"Sayre",x:263,y:200},
            {name:"Cache",x:362,y:277},
            {name:"Ringling",x:414,y:335},
            {name:"Ryan",x:416,y:345},
            {name:"Walters",x:378,y:312},
            {name:"Temple",x:372,y:320},
            {name:"Sentinel",x:326.3,y:205},
          ].map(city => (
            <text key={city.name} x={city.x} y={city.y} textAnchor="middle" fontSize={4} fill="#6b7280" fontStyle="italic" style={{ userSelect: "none", pointerEvents: "none" }}>{city.name}</text>
          ))}
          ...
          {filtered.map(loc => {
            ...
            // Convert percentage positions to SVG coordinates within viewBox 150-510, 60-370
            const svgX = 150 + (pos.x / 100) * 360;
            const svgY = 60 + (pos.y / 100) * 310;

            return (
              <g key={loc.id} style={{ cursor: "pointer" }} onClick={() => setSelected(loc)}>
                <title>{loc.name} — {loc.city}</title>
                <path
                  d={`M${svgX},${svgY - 16} C${svgX - 8},${svgY - 16} ${svgX - 8},${svgY - 28} ${svgX},${svgY - 28} C${svgX + 8},${svgY - 28} ${svgX + 8},${svgY - 16} ${svgX},${svgY - 16} Z`}
                  fill={color} stroke="white" strokeWidth={1}
                />
                <circle cx={svgX} cy={svgY - 22} r={3} fill="white" />
                <path d={`M${svgX - 6},${svgY - 16} L${svgX},${svgY - 8} L${svgX + 6},${svgY - 16}`} fill={color} />
              </g>
            );
          })}
        </svg>
