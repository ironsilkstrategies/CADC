  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="cadc-grid-bg py-14 md:py-20" style={{ background: "var(--cadc-blue)" }}>
        <div className="mx-auto max-w-4xl px-5 md:px-8">
          ...
          <p className="text-base md:text-lg leading-relaxed max-w-2xl" style={{ color: "var(--cadc-blue-light)" }}>
            Governance documents, meeting agendas, board schedules, and
      ...
      <div className="mx-auto max-w-4xl px-5 md:px-8 py-10 md:py-14 flex flex-col gap-14">
        ...
        <section aria-labelledby="agendas-heading">
          ...
          >
            <p className="text-sm leading-relaxed" style={{ color: "#374151" }}>
              Board meeting agendas and minutes are posted here as they become
              available. For the current meeting schedule or to request a document,
              contact the CADC office directly.
            </p>
            <a
              href={contact.mainPhoneHref}
              className="inline-flex items-center gap-2 rounded-lg px-5 py-3 text-sm font-bold text-white transition-opacity hover:opacity-90 w-full sm:w-auto justify-center sm:justify-start"
              style={{ background: "var(--cadc-blue)" }}
            >
              📞 Call {contact.mainPhone}
            </a>
            {/* Agenda upload portal — populated post-launch via admin dashboard */}
            <div
            ...
            {[
              {
                ...
                detail: "The CADC Board of Directors provides organizational oversight, sets policy, and ensures the agency fulfills its mission across Southwest Oklahoma.",
              },
              {
                icon: "👥",
                title: "Policy Council",
                detail: "The Head Start Policy Council includes parents of enrolled children and community members. Federal law requires their involvement in key program decisions.",
              },
              {
                icon: "📋",
                title: "Community Accountability",
                detail: "As a Community Action Agency, CADC is accountable to the communities it serves. Board meetings are an opportunity for public participation.",
              },
            ].map((item) => (
              <div
                key={item.title}
        ...
        {/* Policy Council */}
        <section
          aria-labelledby="policy-council-heading"
        ...
        >
          ...
          <p className="text-sm leading-relaxed mb-3" style={{ color: "#374151" }}>
            The Head Start Policy Council is a federally required governance body
            made up of parents of currently enrolled Head Start children and
            community representatives. One parent from each Head Start center
            serves on the Policy Council.
          </p>
          <p className="text-sm leading-relaxed mb-5" style={{ color: "#374151" }}>
            Policy Council members participate in decisions about program planning,
            budget, hiring, and policy — giving families a real voice in the program
        ...
        <section aria-labelledby="annual-heading">
          ...
          <h2 id="annual-heading" className="font-serif text-2xl font-bold mb-4" style={{ color: "var(--cadc-blue)" }}>
            Annual Report
          </h2>
          <div
          ...
          >
            <div className="flex-1">
              ...
              <p className="text-xs leading-relaxed" style={{ color: "#6b7280" }}>
                CADC's full annual report — program outcomes, financials, and community impact.
              </p>
            </div>
            <a
